...
public class MockPsiExpressionList implements PsiExpressionList {

	private final PsiExpression[] expressions;

	public MockPsiExpressionList() {
		this(new PsiExpression[0]);
	}

	public MockPsiExpressionList(@NotNull PsiExpression[] expressions) {
